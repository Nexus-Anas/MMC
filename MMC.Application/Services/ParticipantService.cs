...
public class ParticipantService : IParticipantService
{
    ...
    public async Task<ParticipantGetDTO> CreateAsync(ParticipantPostDTO participantPostDTO)
    {
    ...
    public async Task<ParticipantGetDTO> UpdateAsync(ParticipantPutDTO participantPutDTO)
    {
